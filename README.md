...
## WEB v7.44 — Mobile Join Section Readability

- Fixes low-contrast text and green overlap in the mobile Join / How To Join section.

## WEB v7.44 — Force STOVE visual in Server Intel
...
## WEB v7.44 — Auto-refresh Latest Facebook Post
...
## WEB v7.44 — Facebook Caption Formatting
